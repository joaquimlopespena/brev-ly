...
export default function List({ id, shortLink, longLink, accessCount }: ListProps) {
    return (
        <div className="grid grid-cols-[1fr_auto] gap-4 items-center w-full border-b border-gray-200 py-3" id={id}>
            <div className="min-w-0">
                <a href="#" className="text-sm text-blue-600 font-semibold underline block truncate">{shortLink}</a>
